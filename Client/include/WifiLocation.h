...
//#define USE_CORE_PRE_2_5_0 // Uncomment this if you are using Arduino Core
//< 2.5.0
...
class WifiLocation {
 public:
  ...
  wifiloc_status_t getStatus() { return status; }

 protected:
  String _googleApiKey;
  // String _googleApiFingerprint = "2c 86 e4 67 e7 b5 ca df 11 9e bd 2e 41 c2
  // 4b e8 b6 7e cd aa"; IPAddress _googleApiIP = IPAddress(216, 58, 214, 170);
